    ...
    transition={{duration:1}} 
     id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
       ...
       className='text-center mb-2 text-lg font-Ovo'>My portfolio</motion.h4>
        ...
        Welcome to my web development portfolio! Explore a showcase of innovative projects
         where creativity meets functionality. From responsive designs to dynamic web applications,
          each project reflects my dedication to crafting exceptional digital experiences. Dive in and 
